const updates = [
  {
    ...
    "changes": [
      ...
      },
      {
        ...
        "type": "가격",
        "sector": "에너지",
        "detail": "브렌트·WTI·천연가스. 브렌트 100달러대 후퇴·유가 급락 국면 진입·미·이란 유조선 상호 타격 후 호르무즈 해협 리스크 완화 관측이 카테고리 상단 카운터 축, 다만 OPEC+ 감산 자율성 회의 다음 주 카운트다운이 하방 지지 서사 유지. 미 CPI 헤드라인 3.4% 컨센 부합·8월 PPI +0.4% 에너지 급등 기여 서사 완화가 정책 렌즈 매파 인상 확률 상승 카운터 축, 디젤·난방유 급등 서사도 후퇴 국면. 알래스카 LNG 프로젝트 한국 참여 협의 관측이 천연가스 카테고리 서사 유지, cross-asset 렌즈로는 유가 후퇴·달러 강세 유지·금리 소폭 하락 3연동이 매크로 방향 축, 정책 렌즈로는 유가 스파이크 완화가 CPI 재점화 시나리오 후퇴 축."
      },
      {
        "time": "2026-09-12 07:18 KST",
        "type": "가격",
