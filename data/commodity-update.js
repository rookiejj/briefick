const updates = [
  {
    "date": "2026-09-26 07:30 KST",
    "summary": "리플 1.60달러 +4.3% 급등 - 알트 강세 재점화, XRP ETF 후속 프리미엄\n솔라나 120달러 +2.4% - 크립토 도미넌스 알트 로테이션 확대\n비트코인 84,290달러 보합 - 옵션 만기 대기, 상단 매물 소화\n금 4,293달러 +0.4% - 채권 발작 국면 안전자산 헤지 재유입\nWTI 92달러 -2.2% - 이란 7일 계획 호르무즈 재개 관측 프리미엄 완화",
    "changes": [
      {
        "time": "2026-09-26 07:00 KST",
        "type": "가격",
        "sector": "크립토",
        "detail": "비트코인(BTC)·이더리움(ETH)·솔라나(SOL)·리플(XRP). BTC 84,290달러 -0.1% 보합·ETH 2,709달러 +0.8%·SOL 119.79달러 +2.4%·XRP 1.60달러 +4.3% 흐름이 카테고리 카타리스트 최대 축, 알트 강세 재점화·9/26 옵션 만기 140억달러 대기 서사가 근거. cross-asset 렌즈로는 미 10년물 5.11% 유지 국면에도 크립토 매수 재유입이 위험선호 회복 축, monetization 렌즈로는 SEC 크립토 프레임워크 정착·솔라나·XRP ETF 승인 후속 프리미엄 확대 축, sector rotation 렌즈로는 비트 도미넌스 재조정·알트 광폭 매수 흐름, 정책 렌즈로는 미 크립토 규제 정비·홍콩·싱가포르 스테이블코인 프레임워크 카타리스트, 시나리오 렌즈로는 옵션 만기 후 방향 결정이 4분기 크립토 축 방향타."
      },
      {
        "time": "2026-09-26 07:00 KST",
        "type": "가격",
